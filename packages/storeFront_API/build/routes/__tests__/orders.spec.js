...
describe("routes/orders", function () {
    describe("GET /orders/:userId", function () {
        it("returns the users current cart", function () { return __awaiter(void 0, void 0, void 0, function () {
            var fakeUser, _a, status, user_id;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, (0, createFakeUser_1.createFakeUser)()];
                    case 1:
                        fakeUser = _b.sent();
                        return [4 /*yield*/, (0, createFakeOrder_1.createFakeOrder)(fakeUser.id)];
                    case 2:
                        _b.sent();
                        return [4 /*yield*/, request.get("/orders/".concat(fakeUser.id))];
                    case 3:
                        _a = (_b.sent())
                            .body, status = _a.status, user_id = _a.user_id;
