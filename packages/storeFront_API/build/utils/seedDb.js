...
var createFakeOrder_1 = require("./createFakeOrder");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, createFakeUsers_1.createFakeUsers)(10)];
            case 1:
                _a.sent();
                console.log("Created 10 fake users");
                console.log("Creating 10 fake products");
                return [4 /*yield*/, (0, createFakeProducts_1.createFakeProducts)(10)];
            case 2:
                _a.sent();
                console.log("Created 10 fake products");
                console.log("Created fake order");
                return [4 /*yield*/, (0, createFakeOrder_1.createFakeOrder)(1)];
            case 3:
                _a.sent();
                return [3 /*break*/, 5];
            case 4:
                error_1 = _a.sent();
                throw new Error("failed to seed DB. ".concat(error_1));
